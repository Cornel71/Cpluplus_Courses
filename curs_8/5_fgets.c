...
int main()
{
    char *pch, buffer[200], numeFisier[25];
...
//        pch = fgets(buffer,200,pf);
//        printf ("\n buffer = %p ", buffer );
//        printf ("\n buffer = %s ", buffer );
//        printf ("\n pch = %p / %s", pch, pch );

//       c = fgets(buffer,200,pf);
//        puts(buffer);
//
//
...
//        do {
//            pch = fgets(buffer,100,pf); //functia fgets returneaza sirul la care pointeaza pointerul buffer
//            if(pch) // if(pch != NULL);
//                printf("%s",buffer);
