...
// functie care ia ca parametrii doi angajati si
...
int main()
{
    ...
    printf("Angajatul cu cea mai mare vechime este: %s are varsta %d si vechimea %d",
        celMaiVechiAngajat.nume, celMaiVechiAngajat.varsta, celMaiVechiAngajat.vechime);
